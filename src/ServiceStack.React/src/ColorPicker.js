            ...
            NumberPicker = (function (_super) {
                ...
                NumberPicker.prototype.render = function () {
                    return (React.createElement("p", null,
                        React.createElement("input", { type: "range", value: this.props.value.toString(), min: "0", max: "255", onChange: this.handleChange }),
            ...
            ColorPicker = (function (_super) {
                ...
                ColorPicker.prototype.render = function () {
                    ...
                    return (React.createElement("div", null,
                        React.createElement(NumberPicker, { name: "Red", value: rgb.r, onChange: this.updateRed }),
                        React.createElement(NumberPicker, { name: "Green", value: rgb.g, onChange: this.updateGreen }),
                        React.createElement(NumberPicker, { name: "Blue", value: rgb.b, onChange: this.updateBlue }),
