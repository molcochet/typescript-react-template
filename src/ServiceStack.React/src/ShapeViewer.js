...
System.register(["react", "./ColorPicker", "./core"], function (exports_1, context_1) {
    ...
    var React, ColorPicker_1, core_1, ShapeViewer;
    return {
        setters: [
            function (React_1) {
                React = React_1;
        ...
        execute: function () {/// <reference path='../typings/browser.d.ts'/>
            ShapeViewer = (function (_super) {
                ...
                function ShapeViewer(props, context) {
                    ...
                    _this.handleDragInit = function (e) {
                        var el = e.target;
                ...
                ShapeViewer.prototype.render = function () {
                    ...
                    return (React.createElement("div", { className: "noselect", style: { position: "relative", border: "solid 1px #ccc", width: 650, height: 400 } }, this.props.shapes.map(function (s) { return (React.createElement("div", { key: s.id, style: {
                            ...
                            cursor: 'move'
                        }, onMouseDown: _this.handleDragInit, onMouseUp: function (e) { return _this.setState({ isDragging: false }); }, onMouseOut: function (e) { return _this.setState({ isDragging: false }); }, onMouseMove: function (e) { return _this.handleDrag(s.id, s.height, s.width, e); } },
                        "(",
                        s.top,
                        ", ",
                        s.left,
