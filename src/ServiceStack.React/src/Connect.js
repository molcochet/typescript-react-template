...
System.register(["react", "jquery", "ss-utils"], function (exports_1, context_1) {
    ...
    var React, Connect, userChannel, filterUsers;
    return {
        setters: [
            function (React_1) {
                React = React_1;
            ...
            Connect = (function (_super) {
                ...
                Connect.prototype.render = function () {
                    ...
                    return (React.createElement("div", null,
                        React.createElement("div", { style: { fontWeight: "bold" } }, this.renderUser(this.state.currentUser)),
                        React.createElement("div", { style: { padding: "8px 0", textAlign: "center", fontSize: "18px" } },
                            this.state.users.length,
                            " users online:"),
                        this.state.users.map(function (u) { return _this.renderUser(u); }),
                        React.createElement("div", { style: { textAlign: "center", padding: "10px 0" } }, this.state.connectedToUserId ? React.createElement("button", { onClick: function (e) { return _this.disconnect(); } }, "disconnect") : null)));
                };
                Connect.prototype.renderUser = function (u) {
                    ...
                    return (React.createElement("div", { key: u.userId, onClick: function (e) { return _this.connectToUser(u.userId); }, style: {
                        ...
                        React.createElement("img", { src: u.profileUrl, style: { height: 24, verticalAlign: "middle" } }),
                        React.createElement("span", { style: { padding: "2px 5px" } },
                            u.displayName,
                            " ",
                            u.userId === this.state.currentUser.userId ? " (me)" : "")));
                };
